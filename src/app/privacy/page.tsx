        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-dark/80">
              ...
              secure payment processing through Stripe, and regular security audits to 
          ...
          <section>
            ...
            <p className="text-dark/80 mt-4">
              To exercise these rights, contact us at hello@afrobirthday.com
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-dark/80">
              We use trusted third-party services including Stripe for payments and 
